<div class="modal fade" aria-hidden="true" id="modal-edit-{{$cliente->id}}" tabindex="-1" role="dialog" tabindex="-1"
    aria-hidden="true">
    <form method="POST" action="{{route('admin.clientes.update',Crypt::encryptString($cliente->id))}}">
        @method('PUT')
        @csrf
                ...
                <div class="modal-body col-12">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="rfc" class="form-control" placeholder="Ingrese el rfc del cliente"
                            ...
                            title="Solo se permiten letras. Tamaño mínimo: 2. Tamaño máximo: 12"
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group mb-3">
                            <input type="number" name="descuento" class="form-control"
                                value="{{old('descuento',$cliente->descuento)}}">
